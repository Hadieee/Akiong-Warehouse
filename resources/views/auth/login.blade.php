    ...
    <div class="relative">
        ...
        <div class="absolute top-0 left-0 w-full h-full bg-opacity-50 bg-gray-200">
            ...
            <form action="{{ route('login.action') }}" method="post" class="w-full flex flex-col items-start">
                @csrf
                <div
                    class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl mt-40 mb-40">
                    ...
                    @endif
                        ...
                        <div class="mt-4">
                            <label class="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200">Role</label>
                            <select name="role"
                                class="block w-full px-4 py-2 text-gray-700 bg-white border rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-300">
                        ...
                        <div class="flex items-center justify-between mt-4">
                            ...
                            <a href="{{ route('register') }}"
                                class="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline">Don't have an
                                account?</a>
