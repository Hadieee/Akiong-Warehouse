    ...
    <div class="relative">
        ...
        <div class="absolute top-0 left-0 w-full h-full bg-opacity-50 bg-gray-200">
            ...
            <form action="{{ route('register.action') }}" method="post" class="w-full flex flex-col items-start">
                <div
                    class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl mt-20 mb-20">
                    @csrf
                    <img class="lg:block lg:w-1/2 hidden md:block" src="{{ asset('assets/sign_up.png') }}" alt="">
