...
@section('content')
    ...
    <div class=" sm:ml-64">
        <div class="flex flex-col h-screen px-6 py-8 rounded items-center bg-gray-700 overflow-auto">
            ...
            <div class="h-full w-full m-4 p-8 rounded bg-white drop-shadow-md">
