    ...
    @section('title')
        Tambah Data Barang - Akiong Warehouse
    @endsection
        ...
        <div class="relative h-screen">
            ...
            <div class="flex items-center justify-center h-full absolute inset-0">
                <div class="w-full max-w-sm p-4 border rounded-lg shadow sm:p-6 md:p-8 bg-gray-800 border-gray-700">
                    <form class="space-y-6" action="{{ route('admin.storeBarang') }}" method="post">
                        @csrf
                        <a href="/admin/barang">
                        ...
                        <div>
                            <label for="pemasok_id"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pemasok Barang</label>
